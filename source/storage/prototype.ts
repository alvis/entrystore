...
export abstract class StorageAdapter {
   ...
   */
  public abstract async collection(extension?: string): Promise<string[]>;
   ...
   */
  public abstract async size(path: string): Promise<number>;
   ...
   */
  public abstract async read(path: string): Promise<Buffer>;
   ...
   */
  public abstract async head(path: string, lines?: number): Promise<string>;
   ...
   */
  public abstract async tail(path: string, lines?: number): Promise<string>;
